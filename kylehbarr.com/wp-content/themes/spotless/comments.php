...
<?php if ($comments) : ?>
	<h3 id="comments"><?php comments_number('No comments', '1 comment', '% comments' );?> in  &#8220;<?php the_title(); ?>&#8221;</h3> 
...
<p>You must <a href="<?php echo get_option('siteurl'); ?>/wp-login.php?redirect_to=<?php the_permalink(); ?>">logged in</a></p>
<?php else : ?>
...
<p><textarea name="comment" id="comment" cols="49" rows="5" tabindex="4"></textarea></p>
